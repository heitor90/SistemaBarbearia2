 ...
 * @author Home
 */
public class telaFuncionarioLogin extends javax.swing.JFrame {

    /**
     * Creates new form telaFuncionarioLogin
     */
    ...
    private void initComponents() {
        ...
        setTitle("Login Funcionário - Barbearia");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        JFrame janela = new telaFuncionario();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(telaFuncionarioLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new telaFuncionarioLogin().setVisible(true);
            }
        });
    }
