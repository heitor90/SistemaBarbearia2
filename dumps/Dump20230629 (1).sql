...
INSERT INTO `agenda` VALUES (1,'gfhgfhgfgh','','Barba tradicional','Low Fade',NULL),(2,'55','777','Barba tradicional','Low Fade',NULL),(3,'Heitor','somente o basico','Balbo','Militar',NULL),(4,'afonso','Nada, somente o basico','Barba degradê','Militar',NULL),(5,'Luis otavio','Nada','Barba degradê','Top knot ou coque samurai',NULL),(6,'Heitor Lopes','AHKJASHKJASHJASK','Barba degradê','Militar',NULL),(7,'sasasaa','sasasas','Barba degradê','Militar',NULL),(8,'asasa','asasas','Barba arredondada','Americano',NULL),(9,'akhsakjjs','saasas','Undercut','Barba degradê','14:30');
...
INSERT INTO `comentario` VALUES (NULL,'a','a','a','a'),(NULL,'Nada','Não','Sim','Sim'),(NULL,'nada','não','sim						','muito sastifeito	'),(NULL,'aksaks','sasas','sim	','msaksa'),(NULL,'asaasa','sasaasa','saksaash','sasass'),(NULL,'sasaaaa','sasasasa','sasasa','sasa'),(NULL,'a','a','aa','a'),('asasas','sasa','sasaa','saaaa','sasas'),('dffgf','sasas','sasas','hjhjjhhjg	','		aasasa');
...
-- Dump completed on 2023-06-29  3:21:01
